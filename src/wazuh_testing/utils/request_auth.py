...
# /enroll authenticates with a `wazuh-enroll+jwt` bearer, not with a CMAC header: see
# wazuh_testing.utils.jwt_enroll. The AES-CMAC enrollment scheme this module used to carry left
# the product in wazuh/wazuh#38582 and is gone from here too, so nothing can be written against it
# by accident.
