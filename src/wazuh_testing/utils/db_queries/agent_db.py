...
def insert_os_info(agent_id='000', scan_id=int(time.time()),
                   ...
                   architecture='x64', os_name='CentOS Linux', os_version='8.4', os_type='', os_major='8',
                   os_minor='4', os_patch='', os_platform='centos', sysname='Linux', release='',
    ...
    query_string = f"agent {agent_id} sql INSERT OR REPLACE INTO sys_osinfo (scan_id, scan_time, hostname, " \
                   'architecture, os_name, os_version, os_type, os_major, os_minor, os_patch, ' \
                   ...
                   f"'{os_version}', '{os_type}', '{os_major}', '{os_minor}', '{os_patch}', " \
